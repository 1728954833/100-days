...
function view(data) {
  return (0, _snabbdom.h)("div", [(0, _snabbdom.h)("button", {
    on: {
      click: sort
    }
  }, "Sort"), (0, _snabbdom.h)("button", {
    on: {
      click: add
    }
  }, "Add"), (0, _snabbdom.h)("div", {}, data.map(function (item) {
    return (0, _snabbdom.h)("div", {
      ...
      key: item.id
    }, "".concat(item.name, " - ").concat(item.age));
  }))]);
}
...
},{"snabbdom":"node_modules/snabbdom/build/index.js"}],"node_modules/_parcel-bundler@1.12.5@parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/snabdom.e31bb0bc.js.map